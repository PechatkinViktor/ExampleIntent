...
public class MapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        testModel2 = new TestModel(mForFirsString.toString(), mForSecondString.toString(), mForFirstList, mForSecondList);

        mFirstTextView.setText(testModel2.getFirstString());
        mSecondTextView.setText(testModel2.getSecondString());
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putParcelable(SAVED_TEST_MODEL, testModel2);
    }

    @Override
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
        super.onRestoreInstanceState(savedInstanceState);
        testModel2 = savedInstanceState.getParcelable(SAVED_TEST_MODEL);
        mFirstTextView.setText(testModel2.getFirstString());
        mSecondTextView.setText(testModel2.getSecondString());
    }
}